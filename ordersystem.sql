...
INSERT INTO `admin` VALUES (2, '13350796566', 'a123456', '小明', '2019-10-21 19:32:09', '2019-10-21 19:32:12');
...
CREATE TABLE `commodity`  (
  ...
  `commodityName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `order`  (
  ...
  `userId` int(200) NOT NULL,
  `statue` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sum` float(200, 2) NOT NULL,
  `createDate` datetime(0) NOT NULL,
  `updateDate` datetime(0) NOT NULL,
  PRIMARY KEY (`orderId`) USING BTREE,
  INDEX `userId_order`(`userId`) USING BTREE,
  CONSTRAINT `userId_order` FOREIGN KEY (`userId`) REFERENCES `user1` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES (1, 1, '已取消', 32.30, '2019-10-21 19:54:13', '2019-10-21 19:54:15');
INSERT INTO `order` VALUES (2, 1, '配送中', 22.00, '2019-10-21 19:53:50', '2019-10-21 19:53:53');
INSERT INTO `order` VALUES (3, 1, '已完成', 50.40, '2019-10-21 19:53:24', '2019-10-21 19:53:27');
