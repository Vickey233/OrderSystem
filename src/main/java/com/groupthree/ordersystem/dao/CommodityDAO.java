...
public interface CommodityDAO extends BaseMapper<Commodity> {
    ...
    public Commodity getByCommodityName(@Param("commodityName") String commodityName);

    public List<CommodityVo> getCommodityPage(@Param("commodityName") String commodityName, Page<CommodityVo> page);

    public ShowCommodityVo getShowCommodityVo(@Param("commodityId") Integer commodityId);
