...
public class OrderCommodityController {
    ...
    public Object commodityList(@RequestParam("orderId") String orderId,@RequestParam("userId") Integer userId) {
        return orderCommodityService.getOrderComVo(orderId,userId);
    }
}
